...
#include "TowerOfHanoi_V3Character.generated.h"
...
public:
	...
	TSubclassOf<class ATowerOfHanoi_V3Projectile> ProjectileClass;
...
protected:
	...
	void EnableIsDragging();
	void DisableIsDragging();
